          ...
          >
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Whether you need consultation on authentication systems, want to
                explore AI automation solutions, or have an interesting project
                opportunity, I'm always open to meaningful conversations.
              </p>
            </div>
            ...
            <Card className="bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800 p-6">
              ...
              <p className="text-green-700 dark:text-green-300 text-sm">
                Open to new opportunities in backend engineering, authentication
          ...
          >
            <Card className="p-8">
              ...
              <p className="text-xs text-muted-foreground mt-4 text-center">
                Form submissions will be processed securely. Expect a response
                within 24-48 hours.
              </p>
            </Card>
          </motion.div>
